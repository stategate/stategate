...
_STREAMMESSAGEOPTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\342\337\037\007\n\005^\\S+$'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='consumer_group', full_name='stategate.StreamMessageOpts.consumer_group', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAMEVENTOPTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=_b('\342\337\037\007\n\005^\\S+$'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='consumer_group', full_name='stategate.StreamEventOpts.consumer_group', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
