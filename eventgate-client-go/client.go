...
func (c *Client) Send(ctx context.Context, in *eventgate.CloudEvent) error {
	_, err := c.client.Send(ctx, in)
	return err
}

func (c *Client) Request(ctx context.Context, in *eventgate.CloudEvent) (*eventgate.CloudEvent, error) {
