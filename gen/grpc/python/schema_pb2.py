...
_RECEIVEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='qgroup', full_name='cloudEventsProxy.ReceiveRequest.qgroup', index=1,
